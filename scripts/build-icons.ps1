...
# il file originale (tile squircle bianco su sfondo trasparente).
#
...
# resta identica a quella originale: nessun ingrandimento, nessun
# ritaglio.
#
...
#
# Qui lo squircle del logo NON va incluso: la maschera di Android lo
